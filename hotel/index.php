        ...
        <div class="col-lg-8 bg-blue p-4">
            ...
            <form method="POST" autocomplete="off">
                <div class="row mb-3">
                    ...
                    <div class="col-lg-2">
                        <label class="form-label d-block text-center" style="font-weight:500;">TYPE</label>
                        <select class="form-control shadow-none" name="checkroom">
            ...
            <div class="card-body">
               <h5>Simple room</h5>
                <h6 clas="mb-4">रु 200 per night</h6>
                    <a href="#" class="btn btn-primary ml-7" class="popup">Book now</a>
            ...
            <div class="card-body">
               <h5>Double room</h5>
                <h6 clas="mb-4">रु 400 per night</h6>
                    <a href="#" class="btn btn-primary ml-7" data-bs-toggle="modal" data-bs-target="mymodal" >Book now</a>
                      <a href="#" class="btn btn-primary">More detail</a>
